...
class Etudiant
{
    ...
    /**
     * @var
     * @ORM\OneToOne(targetEntity="Wahid\HandlingUserBundle\Entity\Media",cascade={"persist"})
     */
    private $media;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Wahid\HandlingUserBundle\Entity\CompteSocial",mappedBy="etudiant")
     */
